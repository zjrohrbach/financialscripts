...
(cat <<EOF) | gnuplot
	...
	set ylabel "Amount"
	plot "ledgeroutput1.tmp" using 2:xticlabels(1) notitle linecolor rgb "green", '' using 0:2:2 with labels font "Courier,8" offset 0,0.5 textcolor linestyle 0 notitle
EOF
